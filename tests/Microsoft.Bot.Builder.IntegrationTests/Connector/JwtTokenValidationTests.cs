...
namespace Microsoft.Bot.Builder.IntegrationTests.Connector
{
    ...
    public class JwtTokenValidationTests
    {
        ...
        public async void Channel_MsaHeader_Valid_ServiceUrlShouldBeTrusted()
        {
            ...
            Assert.IsTrue(MicrosoftAppCredentials.IsTrustedServiceUrl("https://smba.trafficmanager.net/amer-client-ss.msg/"));
        }
        ...
        public async void Channel_AuthenticationDisabled_ShouldBeAnonymous()
        {
            ...
            Assert.AreEqual("anonymous", claimsPrincipal.AuthenticationType);
        }
